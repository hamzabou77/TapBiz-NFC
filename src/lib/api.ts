...
function mapRowToClient(row: any): ClientProfile {
  ...
  return {
    ...
    job_title: p.job_title ? String(p.job_title) : undefined,
    slug,
    logo: String(p.logo || ''),
    ...
    themeColor: p.themeColor || p.theme_color || 'blue',
    ...
    tiktok: String(p.tiktok || p.tiktok_url || ''),
    tiktok_url: String(p.tiktok_url || p.tiktok || ''),
    linkedin: String(p.linkedin || p.linkedin_url || ''),
    linkedin_url: String(p.linkedin_url || p.linkedin || ''),
...
export async function createClient(
  ...
  const profileData: ClientProfile = {
    ...
    themeColor: clientData.themeColor || 'blue',
    ...
    tiktok: clientData.tiktok || clientData.tiktok_url || '',
    tiktok_url: clientData.tiktok_url || clientData.tiktok || '',
    linkedin: clientData.linkedin || clientData.linkedin_url || '',
    linkedin_url: clientData.linkedin_url || clientData.linkedin || '',
